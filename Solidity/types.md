...
int public myInt = 1;
```
Integers can be positive or negative, i.e., signed. If you do not want a number to be negative, you can create an unsigned integer like this:
```c++
